...
KEYWORD_PATTERNS = [
    "芳疗", "Para-Soul", "Paragate", "小红书", "抖音", "公众号",
    "MJ prompt", "md2card", "browser-use", "Stargate", "GitHub",
    "千问", "DeepSeek", "Reddit推广", "Chrome CDP", "WSL",
    "LiblibAI", "Claude", "OpenCode", "Cursor", "Copilot",
    "systemd", "cron", "sync", "daemon", "Hermes",
]
