...
| 版本 | 日期 | 改动 |
|:--------|:-----|:--------|
| **v3.0.0** | 2026-06-01 | 本地优先架构，daemon 健康检查，云端退化为被动加密存储（有 DID 才启用） |
| v2.1.0 | 2026-05-31 | Phase 1 客户端加密（Ed25519→HKDF→AES-256-GCM，服务器零知识） |
| v2.0.0 | 2026-05-31 | 全文件同步、记忆蒸馏、13→10 文件（profile 合并） |
| v1.3.0 | 2026-05-25 | 写循环参考、反模式、--fill 缺口检测 |
